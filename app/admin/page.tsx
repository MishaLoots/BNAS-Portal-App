              ...
              return (
                <div key={key} className="card p-0">
                  ...
                  >
                    ...
                    <span className="font-semibold text-navy text-xs w-24 shrink-0">{label}</span>
                    <span className="text-xs text-gray-400 w-14 shrink-0">{items.length} show{items.length !== 1 ? "s" : ""}</span>
