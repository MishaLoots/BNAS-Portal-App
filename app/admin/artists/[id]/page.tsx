...
type Tab = "shows" | "escrow" | "payouts" | "loan"
      ...
      <main className="flex-1 p-4 sm:p-6 max-w-7xl mx-auto w-full space-y-4">
        ...
        {tab === "shows" && (
          <div className="card p-0">
            ...
            {showForm && (
              <div className="p-6 border-b border-gray-100 bg-blue-50 grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div className="col-span-4">
                  <button onClick={addShow} disabled={saving} className="btn-primary">{saving ? "Saving…" : "Save Show"}</button>
                </div>
              </div>
            )}
              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th className="text-right">Comm</th><th className="text-right">Band</th>
              ...
              <div className="table-wrap rounded-none rounded-b-xl">
                <table>
                  ...
                  <tbody>
                    {transfers.map(t => (
                      <tr key={t.id}>
                        <td className="text-gray-500 whitespace-nowrap">{t.transfer_date}</td>
                        <td>{t.description}</td>
                      ...
                      <tr key={p.id}>
                        ...
                        <td className="text-center">
                          {p.approved_by_artist
                            ? <span className="text-green-600 text-xs font-medium">✓ Approved {p.approved_at?.slice(0,10)}</span>
                ...
                <tbody>
                  {loans.map(l => (
                    <tr key={l.id} className="border-t">
                      <td className="py-1 text-gray-500">{l.repayment_date}</td>
